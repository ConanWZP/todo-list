...
import styl from './../Todolists/Tasks.module.css'

const Header = (props) => {
	return (
		<header className={styles.header}>
			<div className={styles.article}>ToDoLiStS</div>
			...
			<div className={styles.loginBlock}>
				{props.isAuth ?
					<div className={styles.loginTrue}><span className={styles.loginName}>{props.login} - </span><button className={styl.form__button_mode} onClick={props.logout}>Logout</button></div>
